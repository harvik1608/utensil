	...
	<div class="container-xxl flex-grow-1 container-p-y">
		<div class="card">
			<h5 class="card-header">
				FAQs <a href="<?php echo base_url('faqs/new'); ?>" class="btn btn-primary btn-sm text-white" style="float: right;">New</a>
			</h5>
			<div class="container">
					...
					<tbody>
						...
						?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url('faqs/'.$val['id'].'/edit'); ?>" data-bs-toggle="tooltip" data-bs-offset="0,6" data-bs-placement="left" data-bs-html="true" data-bs-original-title="Edit"><i class="icon-base bx bx-edit icon-sm"></i></a>
											<a href="javascript:;" data-bs-toggle="tooltip" data-bs-offset="0,6" data-bs-placement="right" data-bs-html="true" data-bs-original-title="Remove" onclick="remove_row('<?php echo base_url('faqs/'.$val['id']); ?>')"><i class="icon-base bx bx-trash icon-sm"></i></a>
										</td>
									</tr>
						<?php
								}
