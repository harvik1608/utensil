	...
	<div class="container-xxl flex-grow-1 container-p-y">
		<div class="card">
			<h5 class="card-header">
				Categories <a href="<?php echo base_url('categories/new'); ?>" class="btn btn-primary btn-sm text-white" style="float: right;">New</a>
			</h5>
			<div class="container">
					...
					<tbody>
						...
						?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url('categories/'.$val['id'].'/edit'); ?>" title="Edit"><i class="icon-base bx bx-edit icon-sm"></i></a>
											<a href="javascript:;" onclick="remove_row('<?php echo base_url('categories/'.$val['id']); ?>')" title="Delete"><i class="icon-base bx bx-trash icon-sm"></i></a>
										</td>
									</tr>
						<?php
								}
